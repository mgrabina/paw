...
<html>
<head>
<title>Chozapp an Admin Panel Category Flat Bootstrap Responsive Website Template | Maps :: w3layouts</title>
...
<!---->
 <script type="text/javascript" src="//maps.google.com/maps/api/js?sensor=true"></script>
  <script type="text/javascript" src="<c:url value="/resources/js/gmaps.js"></c:url>" ></script>
  <link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/examples.css"></c:url>" />
</head>
<body>
<div id="wrapper">
        <!----->
